...
@endpush
    <div class="flex flex-grow w-full">
        <div class="flex flex-grow w-full flex-col bg-white border border-gray-200 shadow-lg rounded-xl overflow-hidden">
            ...
            <div class="flex flex-grow w-full justify-center items-center" >
                <div class="flex p-6 flex gap-14 justify-center items-center" style="width: 85%">
